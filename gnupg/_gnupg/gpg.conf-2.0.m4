...
# This configuration requires GnuPG 2.0.12. Keep roughly synced with
# gpg.conf and gpg.conf-1.4.
#
# Any and all rationales are naïve. I have no idea what I'm doing.

# Replace the outdated 2.0.12 default (SHA1 → SHA256 → RIPEMD160) with
# the 2.2.4 default.
...
# (`no-emit-version` is the default in 2.0.31.)
no-emit-version
throw-keyids
